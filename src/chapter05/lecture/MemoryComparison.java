...
public class MemoryComparison {
    public static void main(String[] args) {
        ...
        int i = 1; // 메모리 번지에 i라는 이름의 라벨링을 붙임. 해당 값이 메모리 4 byte 공간에 저장
        float f = 10.f;
        char c ='A';

        // 참조 자료형(Reference Type) : 클레스, 문자열(String), 배열 등
        // Heap 메로리에 객체를 만들고, 다른 곳에 그 주소를 저장함
        ...
        String str3 = new String("Hello"); // String Constant Pool에 저장
