...
public class UserFactory {
    ...
    // 객체를 인스턴스화 할 때 직접적으로 생성자를 호출하여 생성했는데,
    ...
    static {
        ...
        cache.add(new User("윤하겸", "010-0000-0002"));
        cache.add(new User("유근규", "010-0000-0003"));
        cache.add(new User("이유나", "010-0000-0004"));
        cache.add(new User("유현담", "010-0000-0005"));
    }
